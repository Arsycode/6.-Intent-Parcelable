    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Gilang M. Arsy");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Gilang M. Arsy");
                mPerson.setAge(17);
                mPerson.setEmail("gilangmarsy2@gmail.com");
